...
public class ST_PuzzleTile : MonoBehaviour
{
	...
	public void SetCollor()
	{
		if(CorrectLocation)
		{
			amiguinho.material = color2;
		}
		else
		{
			amiguinho.material = color1;
		}
	}

	public bool ChangeCollor()
	{
		if (CorrectLocation && amiguinho.material == color2)
		{
			return false;
		}
		if(!CorrectLocation && amiguinho.material == color1)
		{
			return false;
		}
		return true;
